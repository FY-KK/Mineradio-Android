...
class ParticleGalaxyRenderer {
    ...
    fun onSurfaceCreated() {
        ...
        pSizeScaleLoc = GlUtils.uniformLocation(particleProgram, "uSizeScale")
        pSpeedScaleLoc = GlUtils.uniformLocation(particleProgram, "uSpeedScale")
        pTwistScaleLoc = GlUtils.uniformLocation(particleProgram, "uTwistScale")
        pColorScaleLoc = GlUtils.uniformLocation(particleProgram, "uColorScale")
        pBloomScaleLoc = GlUtils.uniformLocation(particleProgram, "uBloomScale")
        pScatterScaleLoc = GlUtils.uniformLocation(particleProgram, "uScatterScale")
