...
class ShelfRenderer {
    ...
    fun onSurfaceCreated() {
        ...
        uOpacityLoc = GlUtils.uniformLocation(program, "uOpacity")
        uAccentLoc = GlUtils.uniformLocation(program, "uAccent")
        uBgAlphaLoc = GlUtils.uniformLocation(program, "uBgAlpha")
